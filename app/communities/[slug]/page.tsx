...
const communityData: Record<string, { name: string; description: string; priceRange: string; details: string }> = {
  riverview: {
    name: "Riverview",
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 pt-8 border-t border-border">
            ...
            <div className="rounded-lg border border-dashed border-border p-8 text-center">
              ...
              <Link href={`/search?city=${community.name}`} className="mt-3 inline-flex items-center gap-1 text-sm text-gold hover:underline">
